...
– Transfert SFTP, puis envoi d’un rapport synthétique par e-mail
"""
...
FILE_TIMEOUT = 600                                # 10 min pour les .tif
...
# Image vide pour les périodes sans données
empty_img = (
...
for site_id in SITE_IDS:
    ...
    # Dossier Drive correspondant au site
    query = f"name='{site_name}' and mimeType='application/vnd.google-apps.folder' and trashed=false"
    ...
    # Création des exports EE
    step = 10     # jours
    period = 30   # fenêtre de 30 jours
    ...
    while pending and time.time() - start_time < WAIT_TIME:
